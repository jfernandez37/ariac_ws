...
size_t AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__size_function__KitTrayPose__tray_poses(
  const void * untyped_member)
{
...
const void * AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__get_const_function__KitTrayPose__tray_poses(
  const void * untyped_member, size_t index)
{
  const ariac_msgs__msg__KitTrayPose__Sequence * member =
    (const ariac_msgs__msg__KitTrayPose__Sequence *)(untyped_member);
...
void * AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__get_function__KitTrayPose__tray_poses(
  void * untyped_member, size_t index)
{
...
bool AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__resize_function__KitTrayPose__tray_poses(
  void * untyped_member, size_t size)
{
  ariac_msgs__msg__KitTrayPose__Sequence * member =
    (ariac_msgs__msg__KitTrayPose__Sequence *)(untyped_member);
...
static rosidl_typesupport_introspection_c__MessageMember AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__AdvancedLogicalCameraImage_message_member_array[3] = {
  {
    "part_poses",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__size_function__KitTrayPose__tray_poses,  // size() function pointer
    AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__get_const_function__KitTrayPose__tray_poses,  // get_const(index) function pointer
    AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__get_function__KitTrayPose__tray_poses,  // get(index) function pointer
    AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__resize_function__KitTrayPose__tray_poses  // resize(index) function pointer
  },
  {
    "sensor_pose",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, AdvancedLogicalCameraImage)() {
  ...
  AdvancedLogicalCameraImage__rosidl_typesupport_introspection_c__AdvancedLogicalCameraImage_message_member_array[2].members_ =
