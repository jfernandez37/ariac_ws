...
#include "ariac_msgs/msg/detail/challenge_condition__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::ChallengeCondition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::ChallengeCondition & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::ChallengeCondition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::ChallengeCondition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ChallengeCondition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::ChallengeCondition *>(
...
{
  return max_serialized_size_ChallengeCondition(full_bounded, 0);
}

static message_type_support_callbacks_t _ChallengeCondition__callbacks = {
  "ariac_msgs::msg",
  "ChallengeCondition",
...
static rosidl_message_type_support_t _ChallengeCondition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ChallengeCondition__callbacks,
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_ChallengeCondition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, ChallengeCondition)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_ChallengeCondition__handle;
}
