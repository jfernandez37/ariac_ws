...
static const _ChallengeCondition_type_support_symbol_names_t _ChallengeCondition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, ChallengeCondition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ariac_msgs, msg, ChallengeCondition)),
  }
};
...
{
  return &::ariac_msgs::msg::rosidl_typesupport_cpp::ChallengeCondition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ariac_msgs, msg, ChallengeCondition)() {
  return get_message_type_support_handle<ariac_msgs::msg::ChallengeCondition>();
}
