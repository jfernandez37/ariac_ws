...
bool ariac_msgs__msg__part_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._part_pose.PartPose", full_classname_dest, 34) == 0);
  }
  ariac_msgs__msg__PartPose * ros_message = _ros_message;
  {  // part
...
PyObject * ariac_msgs__msg__part_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._part_pose");
