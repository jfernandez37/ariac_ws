...
bool ariac_msgs__msg__part__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._part.Part", full_classname_dest, 25) == 0);
  }
  ariac_msgs__msg__Part * ros_message = _ros_message;
  {  // color
...
PyObject * ariac_msgs__msg__part__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._part");
