...
bool ariac_msgs__msg__kitting_part__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool ariac_msgs__msg__kitting_task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._kitting_task.KittingTask", full_classname_dest, 40) == 0);
  }
  ariac_msgs__msg__KittingTask * ros_message = _ros_message;
  {  // agv_number
  ...
  {  // tray_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "tray_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->tray_id = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // destination
  ...
  {  // parts
    ...
    if (!ariac_msgs__msg__KittingPart__Sequence__init(&(ros_message->parts), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ariac_msgs__msg__KittingPart__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ariac_msgs__msg__KittingPart * dest = ros_message->parts.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ariac_msgs__msg__kitting_part__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of KittingTask */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._kitting_task");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KittingTask");
  ...
  {  // tray_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->tray_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "tray_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // parts
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ariac_msgs__msg__kitting_part__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
