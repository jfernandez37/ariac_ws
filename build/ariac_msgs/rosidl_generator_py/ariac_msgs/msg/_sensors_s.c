...
bool ariac_msgs__msg__sensors__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._sensors.Sensors", full_classname_dest, 31) == 0);
  }
  ariac_msgs__msg__Sensors * ros_message = _ros_message;
  {  // break_beam
...
PyObject * ariac_msgs__msg__sensors__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._sensors");
