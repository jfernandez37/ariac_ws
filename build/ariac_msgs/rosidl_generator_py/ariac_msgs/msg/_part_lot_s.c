...
bool ariac_msgs__msg__part_lot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._part_lot.PartLot", full_classname_dest, 32) == 0);
  }
  ariac_msgs__msg__PartLot * ros_message = _ros_message;
  {  // part
  ...
  {  // quantity
    ...
    ros_message->quantity = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of PartLot */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._part_lot");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PartLot");
