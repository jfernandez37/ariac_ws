...
bool ariac_msgs__msg__conveyor_belt_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._conveyor_belt_state.ConveyorBeltState", full_classname_dest, 53) == 0);
  }
  ariac_msgs__msg__ConveyorBeltState * ros_message = _ros_message;
  {  // power
...
PyObject * ariac_msgs__msg__conveyor_belt_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._conveyor_belt_state");
