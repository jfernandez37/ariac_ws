...
bool ariac_msgs__msg__order_condition__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._order_condition.OrderCondition", full_classname_dest, 46) == 0);
  }
  ariac_msgs__msg__OrderCondition * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of OrderCondition */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._order_condition");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrderCondition");
