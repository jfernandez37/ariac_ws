...
{
  ariac_msgs__msg__ConveyorBeltState * msg = (ariac_msgs__msg__ConveyorBeltState *)malloc(sizeof(ariac_msgs__msg__ConveyorBeltState));
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__msg__ConveyorBeltState__Sequence__init(ariac_msgs__msg__ConveyorBeltState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__msg__ConveyorBeltState *)calloc(size, sizeof(ariac_msgs__msg__ConveyorBeltState));
    if (!data) {
      return false;
    }
...
{
  ariac_msgs__msg__ConveyorBeltState__Sequence * array = (ariac_msgs__msg__ConveyorBeltState__Sequence *)malloc(sizeof(ariac_msgs__msg__ConveyorBeltState__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__msg__ConveyorBeltState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__msg__ConveyorBeltState * data =
      (ariac_msgs__msg__ConveyorBeltState *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__msg__ConveyorBeltState__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ariac_msgs__msg__ConveyorBeltState__fini(&data[i]);
        }
        free(data);
        return false;
      }
