...
{
  ariac_msgs__msg__PartPose * msg = (ariac_msgs__msg__PartPose *)malloc(sizeof(ariac_msgs__msg__PartPose));
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__msg__PartPose__Sequence__init(ariac_msgs__msg__PartPose__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__msg__PartPose *)calloc(size, sizeof(ariac_msgs__msg__PartPose));
    if (!data) {
      return false;
    }
...
{
  ariac_msgs__msg__PartPose__Sequence * array = (ariac_msgs__msg__PartPose__Sequence *)malloc(sizeof(ariac_msgs__msg__PartPose__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__msg__PartPose__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__msg__PartPose * data =
      (ariac_msgs__msg__PartPose *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__msg__PartPose__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          ariac_msgs__msg__PartPose__fini(&data[i]);
        }
        free(data);
        return false;
      }
